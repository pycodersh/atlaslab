...
## ★ Gold Standard 500 (출시 공식 커리큘럼)

현재 확정된 **Pattern 500 · Example 2,500 · Story 100**이 PATTO **최초 출시 버전의 공식 커리큘럼**이자 Gold Standard다.
1~100은 핵심 구조(Level 1~5), 101~200은 생활 상황 확장, 201~500은 **실생활 거의 전 영역 + 회화 Chunk 비중 확대**다.
앞으로 만들 1000 / 4000개의 모든 콘텐츠는 이 500개를 기준으로 확장한다.

목표 수준: **"이 500개의 Pattern만 완벽하게 반복하면 일상 영어를 거의 다 자동화한다."**

> **Gold Standard 500 — Version 1.0 확정 (2026-06-30)**
> Phase 4에서 기존 200을 **수정 없이 유지**하고 Pattern 201~500(Story 41~100)을 3배치(201~300 → 301~400 → 401~500)로 추가, 각 배치마다 중복·연결·빌드 검증을 통과했다.
> - 의미·표현·용법·학습 목적 모두 기존과 **중복 0** (전체 500개 대소문자 무시 비교).
> - 실생활 전 영역 확장: 환불·교환·배달·기내·주차·와이파이·우체국·예약·일정변경·이사·수리·이메일·가족·연애·뉴스/의견·길도움·요리·돈·기기·면접·고객응대·협상·협업·갈등·파티·위로·칭찬·사과·동의/반대·추측·후회·습관·여행계획·관광·렌터카·환전·응급·계절·건강·외식·카페·화상회의·소셜/문자·흥정·인테리어·반려동물·플랜B·시간·빈도 등.
> - **Conversation Chunk 비중 확대**: No worries / Fair enough / My bad / You know what? / By the way / Go ahead / Give me a second / Take your time / You can say that again 등 통째로 익히는 표현을 Story 60·80·100 및 곳곳에 배치.
> - 각 Pattern의 Example 5개는 5개 도메인을 하나씩 → 2,500개 전체 **500/500/500/500/500 완전 균형**.
> - 500 완성 후 콘텐츠 생성을 잠시 멈추고 이미지 큐레이션 · 음성 적용 · SRS/Progress 최종 검증 · 사용자 테스트 · 출시 준비로 넘어간다.
