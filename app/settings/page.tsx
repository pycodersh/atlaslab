  ...
  const BASE_PROVIDERS = [
    {
      ...
      bg: isDark ? '#1C1C1E' : '#FFFFFF', text: isDark ? '#fff' : '#1C1C1E', border: isDark ? 'rgba(80,80,90,0.60)' : 'rgba(200,200,210,0.80)',
    },
    {
      id: 'email',
      ...
      bg: isDark ? '#2C2C2E' : '#FFFFFF', text: isDark ? '#fff' : '#1C1C1E', border: isDark ? 'rgba(80,80,90,0.60)' : 'rgba(200,200,210,0.80)',
    },
  ]
