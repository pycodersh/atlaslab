      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 13, color: '#808090', margin: 0, lineHeight: 1.5 }}>
            Light vs Dark side-by-side. Inline CSS variable overrides — no global class toggling. → <a href="/patto/dev/ui" style={{ color: '#6D8DFF', textDecoration: 'none', fontWeight: 600 }}>/dev/ui</a> · <a href="/patto/dev/screens" style={{ color: '#6D8DFF', textDecoration: 'none', fontWeight: 600 }}>/dev/screens</a>
          </p>
        </div>
