    ...
    <div style={{ minHeight: '100dvh', background: dark ? '#080810' : '#F2F2F2', padding: '28px 20px 100px', boxSizing: 'border-box' }}>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 13, color: '#8888A0', margin: '0 0 20px', lineHeight: 1.5 }}>
          All 6 screens with their dialogs. → <a href="/patto/dev/ui" style={{ color: '#6D8DFF', textDecoration: 'none', fontWeight: 600 }}>/dev/ui</a> · <a href="/patto/dev/theme" style={{ color: '#6D8DFF', textDecoration: 'none', fontWeight: 600 }}>/dev/theme</a>
        </p>
