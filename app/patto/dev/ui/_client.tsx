    ...
    <div style={{ minHeight: '100dvh', background: 'var(--pb)', padding: '28px 20px 100px', maxWidth: 760, margin: '0 auto', boxSizing: 'border-box' }}>
      ...
      <div style={{ marginBottom: 52 }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--pm)', margin: 0, lineHeight: 1.65 }}>
          ...
          {' '}→ <a href="/patto/dev/screens" style={{ color: 'var(--pa)', textDecoration: 'none', fontWeight: 600 }}>/dev/screens</a> · <a href="/patto/dev/theme" style={{ color: 'var(--pa)', textDecoration: 'none', fontWeight: 600 }}>/dev/theme</a>
        </p>
      </div>
