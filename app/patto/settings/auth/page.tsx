...
function AuthContent() {
  ...
  return (
    <div style={{
      ...
      <Link href="/patto/settings" style={{ display: 'flex', alignItems: 'center', gap: 5, textDecoration: 'none', marginBottom: 20 }}>
      ...
      <AuthButtons showTitle={false} onSuccess={() => { window.location.href = '/patto/settings' }} />
