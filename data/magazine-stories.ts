...
export const magazineStories: MagazineStory[] = [
  {
    ...
    introVideo: { enabled: false, source: 'pexels', url: 'https://videos.pexels.com/video-files/36244116/15370437_1280_720_30fps.mp4' },
    ...
    paragraphs: [
      ...
      },
      {
        ...
        media: {
          ...
          imageAlt: 'People enjoying a lively social gathering',
        },
      },
      {
        id: 'p1-3',
        ...
        media: {
          ...
          imageAlt: 'A cozy gathering of friends in the evening',
        },
      },
      {
        id: 'p1-4',
