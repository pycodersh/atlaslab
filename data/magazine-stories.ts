...
export const magazineStories: MagazineStory[] = [
  {
    ...
    scenePractice: {
      ...
      description: 'Watch the scene and practice with subtitles.',
      subtitles: [
        {
          id: 's1',
          start: 0,
          end: 2,
          en: 'It was a normal Friday evening. I just wanted to relax at home.',
          ko: '평범한 금요일 저녁이었다. 나는 그냥 집에서 쉬고 싶었다.',
          patternId: 'pt1-1',
        },
        {
          id: 's2',
          ...
          en: 'Then I just got a text from my friend. "There\'s going to be a small party tonight. Want to come?"',
          ko: '그때 친구에게서 문자가 왔다. "오늘 밤 작은 파티가 있어. 올래?"',
        },
        {
          id: 's3',
          start: 4,
          end: 6,
          en: 'I didn\'t have much time, but I could be there by 7.',
          ko: '시간이 많지 않았지만, 7시까지는 갈 수 있었다.',
        },
        {
          id: 's4',
          start: 6,
          end: 7.5,
          en: 'When I arrived, more friends were already there. I had so much fun.',
          ko: '도착했을 때, 더 많은 친구들이 이미 와 있었다. 정말 즐거웠다.',
        },
        {
          id: 's5',
          start: 7.5,
          end: 8.4,
          en: 'I didn\'t want to leave, but I have to get up early tomorrow.',
          ko: '떠나고 싶지 않았지만, 내일 일찍 일어나야 한다.',
          patternId: 'pt1-2',
        },
      ],
    },
