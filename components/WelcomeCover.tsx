...
export function WelcomeCover() {
  ...
  const [phase, setPhase]             = useState<'hidden' | 'show' | 'fadeout'>('hidden')
  ...
  useEffect(() => {
    ...
    function startFadeout() {
      ...
      setTimeout(() => {
        setPhase('fadeout')
        setTimeout(() => setPhase('hidden'), FADEOUT_MS)
      }, remaining)
    }
    const t3 = setTimeout(startFadeout, MIN_SHOW_MS)
  ...
  return (
    <div
      style={{
        ...
        transition: phase === 'fadeout' ? `opacity ${FADEOUT_MS}ms ease-in-out` : 'none',
        overflow: 'hidden',
      }}
    >
      ...
      <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
        <div style={{
          ...
          background: c1,
          top: '-22vw', right: '-18vw',
          animation: 'coverDriftA 15s ease-in-out infinite',
        }} />
        <div style={{
          position: 'absolute',
          ...
          animation: 'coverDriftB 19s ease-in-out infinite',
        }} />
        <div style={{
          position: 'absolute',
          ...
          animation: 'coverDriftC 24s ease-in-out infinite',
        }} />
      </div>
      ...
      <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        {/* Logo + PATTO wordmark — horizontal */}
        <div style={{
          display: 'flex', alignItems: 'center', gap: 13,
          opacity: brandVisible ? 1 : 0,
          transform: brandVisible ? 'translateY(0)' : 'translateY(14px)',
        ...
        <div style={{
          ...
          transform: sloganVisible ? 'translateY(0)' : 'translateY(9px)',
          transition: transitionIn,
          textAlign: 'center',
        }}>
          <p style={{
