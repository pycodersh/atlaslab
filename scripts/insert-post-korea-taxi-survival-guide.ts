/**
 * blog_posts 단건 INSERT — 'korea-taxi-survival-guide' (Life in Korea)
 *
 ...
 * 표지와 본문 그림 2장은 scripts/gen_taxi_illustrations.py 로 그렸다
 ...
 *
 * 실행: npx tsx scripts/insert-post-korea-taxi-survival-guide.ts
 */
...
const MD_PATH = path.resolve(process.cwd(), 'scripts', '_post-korea-taxi-survival-guide.md')
...
const POST = {
  slug:         'korea-taxi-survival-guide',
  locale:       'en',
  app:          'k-patto',
  category:     'Korean Culture',
  tags:         ['Korea Taxi Guide', 'Seoul Travel', 'Kakao T', 'Public Transit'],
  title:        'Taking Taxis in Korea: The Red Light Paradox, Fare Classes, and Cashless Etiquette',
  description:  "Master Seoul's counterintuitive taxi system: why red lights mean vacant, how vehicle tiers differ, and how to pay without awkward tipping errors.",
  content:      fs.readFileSync(MD_PATH, 'utf8').trimEnd(),
  // 삽입 2분 전 — 과거이면서 직전 글(BBQ 볶음밥 09-21 11:36)보다 뒤
...
async function main() {
  ...
  const PREV = '2026-09-21T11:36:58+00:00'   // 직전 글 korean-bbq-fried-rice-guide
  ...
  const imgs = ['taxi-roof-sign-states.png', 'taxi-types-by-color.png']
