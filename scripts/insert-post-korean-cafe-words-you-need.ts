/**
 * blog_posts 단건 INSERT — 'korean-cafe-words-you-need'
 ...
 *
 * 실행: npx tsx scripts/insert-post-korean-cafe-words-you-need.ts
 */
...
const MD_PATH = path.resolve(
  process.cwd(),
  'scripts',
  '_post-korean-cafe-words-you-need.md'
)

const POST = {
  slug:         'korean-cafe-words-you-need',
  locale:       'en',
  app:          'k-patto',
  category:     'Real-Life Korean',
  tags:         ['cafe', 'vocabulary', 'travel', 'korean words'],
  title:        "10 Korean Words You'll Actually Use in a Cafe",
  description:  "Drink names are already English. These are the ten words that aren't — the ones that come up at the counter, at your table, and on the way out.",
