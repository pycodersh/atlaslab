/**
 * blog_posts 단건 INSERT — 'pay-at-table-or-counter-korea'
 ...
 *
 * 실행: npx tsx scripts/insert-post-pay-at-table-or-counter-korea.ts
 */
...
const MD_PATH = path.resolve(
  process.cwd(),
  'scripts',
  '_post-pay-at-table-or-counter-korea.md'
)

const POST = {
  slug:         'pay-at-table-or-counter-korea',
  locale:       'en',
  app:          'k-patto',
  category:     'Real-Life Korean',
  tags:         ['restaurant', 'payment', 'travel', 'korean phrases'],
  title:        'Do You Pay at the Table or the Counter in Korea?',
  description:  'You can raise your hand for the bill all night and nobody will come. In most Korean restaurants you take the slip to the counter yourself.',
