/**
 * blog_posts 단건 INSERT — 'return-tray-korean-cafe'
 ...
 *
 * 실행: npx tsx scripts/insert-post-return-tray-korean-cafe.ts
 */
...
const MD_PATH = path.resolve(
  process.cwd(),
  'scripts',
  '_post-return-tray-korean-cafe.md'
)

const POST = {
  slug:         'return-tray-korean-cafe',
  locale:       'en',
  app:          'k-patto',
  category:     'Real-Life Korean',
  tags:         ['cafe', 'etiquette', 'travel', 'korean phrases'],
  title:        'Do You Bus Your Own Table in Korean Cafes? (Usually, Yes)',
  description:  'Leaving your cup on the table is fine in most countries. In Korea you take it to the return station — and one short question saves you from guessing.',
