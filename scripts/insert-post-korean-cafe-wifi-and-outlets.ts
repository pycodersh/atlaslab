/**
 * blog_posts 단건 INSERT — 'korean-cafe-wifi-and-outlets'
 ...
 *
 * 실행: npx tsx scripts/insert-post-korean-cafe-wifi-and-outlets.ts
 */
...
const MD_PATH = path.resolve(
  process.cwd(),
  'scripts',
  '_post-korean-cafe-wifi-and-outlets.md'
)

const POST = {
  slug:         'korean-cafe-wifi-and-outlets',
  locale:       'en',
  app:          'k-patto',
  category:     'Real-Life Korean',
  tags:         ['cafe', 'wifi', 'travel', 'korean phrases'],
  title:        'How to Ask for Wifi and a Power Outlet in a Korean Cafe',
  description:  'Korean cafes are built for people who stay for hours. Two questions get you a seat with an outlet and the wifi password.',
