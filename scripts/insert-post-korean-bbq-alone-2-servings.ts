/**
 * blog_posts 단건 INSERT — 'korean-bbq-alone-2-servings'
 ...
 *
 * 실행: npx tsx scripts/insert-post-korean-bbq-alone-2-servings.ts
 */
...
const MD_PATH = path.resolve(
  process.cwd(),
  'scripts',
  '_post-korean-bbq-alone-2-servings.md'
)

const POST = {
  slug:         'korean-bbq-alone-2-servings',
  locale:       'en',
  app:          'k-patto',
  category:     'Real-Life Korean',
  tags:         ['korean bbq', 'restaurant', 'travel', 'solo dining'],
  title:        'Can You Eat Korean BBQ Alone? (Yes, With One Catch)',
  description:  "Nobody will turn you away for dining solo — but most grill restaurants have a two-serving minimum. Here's how to order around it.",
