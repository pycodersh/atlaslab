/**
 * blog_posts 단건 INSERT — 'korean-songpyeon-pine-needles-science' (Korean food)
 *
 ...
 * 둘뿐이다. 송편 빚기·찌기 3단계가 들어 있는 조리 글이라 Cooking Basics(쌈·BBQ 볶음밥 글과 같음).
 * 원고의 category:"culture" 는 쓰지 않는다.
 * 표지(01)는 COVER_BY_SLUG, 본문 이미지 2장(02·03)은 public/images/posts 에 있다.
 ...
 *
 * 실행: npx tsx scripts/insert-post-korean-songpyeon-pine-needles-science.ts
 */
...
const MD_PATH = path.resolve(process.cwd(), 'scripts', '_post-korean-songpyeon-pine-needles-science.md')
...
const POST = {
  slug:         'korean-songpyeon-pine-needles-science',
  locale:       'en',
  app:          'k-pantry',
  category:     'Cooking Basics',
  tags:         ['Songpyeon', 'Korean Food Culture', 'Chuseok', 'Food Science'],
  title:        'The Science of Songpyeon: Why Koreans Steam Rice Cakes on Pine Needles',
  description:  'Discover the biochemistry of pine needle phytoncides, the astronomical symbolism behind the half-moon shape, and the texture balance of traditional fillings.',
  content:      fs.readFileSync(MD_PATH, 'utf8').trimEnd(),
  // 삽입 2분 전 — 과거이면서 직전 Korean food 글(BBQ 볶음밥 09-21 11:36)보다 뒤
...
async function main() {
  ...
  const PREV = '2026-09-21T11:36:58+00:00'   // 직전 Korean food 글 korean-bbq-fried-rice-guide
  ...
  const imgs = ['songpyeon-half-moon-shape.jpg', 'songpyeon-mugwort-and-plain.jpg']
